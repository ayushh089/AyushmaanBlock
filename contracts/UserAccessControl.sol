...
contract UserAccessControl is AccessControl{
    ...
    function addPharmacy(address _pharmacy) external onlyRole(DEFAULT_ADMIN_ROLE) {
    ...
    function removePharmacy(address _pharmacy) external onlyRole(DEFAULT_ADMIN_ROLE) {
